                  ...
                  : Column(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: _TaskPanel(
                            title: '待办',
                            titleFontSize: _settings.todoTitleFontSize,
                            ...
                            child: Column(
                              children: [
                                ...
                                _CompletedPanel(
                                  ...
                                  compact: _settings.compactMode,
                                  titleFontSize:
                                      _settings.completedTitleFontSize,
                                  cardTextFontSize:
                                      _settings.cardTextFontSize,
            ...
            if (widget.completedTodos.isEmpty)
              ...
              ConstrainedBox(
                constraints: BoxConstraints(
                  maxHeight: widget.compact ? 180 : 220,
                ),
                child: Scrollbar(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _TodoCard(
                        ...
                        cardTextFontSize: widget.cardTextFontSize,
                        onToggle: (selected) =>
...
class _TodoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final titleStyle = Theme.of(context).textTheme.titleMedium?.copyWith(
      fontSize: compact ? cardTextFontSize - 1 : cardTextFontSize,
      fontWeight: FontWeight.w600,
      height: 1.25,
              ...
              children: [
                ...
                Text(
                  ...
                  style: Theme.of(
                    ...
                    fontSize: (cardTextFontSize - 3).clamp(11, 16).toDouble(),
                    color: summaryColor,
                  ),
                ),
              ],
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                _FontSizeSliderRow(
                  label: '待办标题字号',
                  value: _draft.todoTitleFontSize,
                  min: 16,
                  max: 26,
                  divisions: 10,
                  onChanged: (value) {
                    setState(() {
                      _draft = _draft.copyWith(todoTitleFontSize: value);
                    });
                  },
                ),
                const SizedBox(height: 8),
                _FontSizeSliderRow(
                  label: '已完成标题字号',
                  value: _draft.completedTitleFontSize,
                  min: 16,
                  max: 26,
                  divisions: 10,
                  onChanged: (value) {
                ...
                _FontSizeSliderRow(
                  label: '卡片文本字号',
                  value: _draft.cardTextFontSize,
                  min: 13,
                  max: 20,
                  divisions: 14,
                  onChanged: (value) {
                    setState(() {
                      _draft = _draft.copyWith(cardTextFontSize: value);
                    });
                  },
                ),
              ],
